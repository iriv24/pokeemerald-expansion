...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_AMY_AND_LIV] = REMATCH(TRAINER_AMY_AND_LIV_1, TRAINER_AMY_AND_LIV_2, TRAINER_AMY_AND_LIV_2, TRAINER_AMY_AND_LIV_2, TRAINER_AMY_AND_LIV_2, ROUTE103),
    ...
    [REMATCH_EZEKIEL] = REMATCH(TRAINER_EZEKIEL_1, TRAINER_EZEKIEL_2, TRAINER_EZEKIEL_2, TRAINER_EZEKIEL_2, TRAINER_EZEKIEL_2, ROUTE117),
