...
} static const sSaveSlotLayout[NUM_SECTORS_PER_SLOT] =
{
    ...
    SAVEBLOCK_CHUNK(struct PokemonStorage, 8), // SECTOR_ID_PKMN_STORAGE_END original
    ...
    SAVEBLOCK_CHUNK(struct PokemonStorage, 22), // SECTOR_ID_PKMN_STORAGE_END new
};
