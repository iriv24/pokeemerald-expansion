...
static bool8 CheckIfStatCantIncrease(void) 
{
    ...
    else if(!FlagGet(FLAG_MIN_GRINDING_MODE) && sStatEditorDataPtr->selector_x == EDITING_IVS)
        return TRUE;
...
bool8 CheckIfStatCantDecrease(void) 
{
    ...
    if(!FlagGet(FLAG_MIN_GRINDING_MODE) && sStatEditorDataPtr->selector_x == EDITING_IVS)
        return TRUE;
