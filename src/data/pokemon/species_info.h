...
const struct SpeciesInfo gSpeciesInfo[] =
{
    ...
    */
    ...
    [SPECIES_TORTERRA_MEGA] =
    {
        ...
        .abilities = { ABILITY_ICE_EATER, ABILITY_ICE_EATER, ABILITY_ICE_EATER, ABILITY_ICE_EATER, ABILITY_ICE_EATER, ABILITY_ICE_EATER },
    ...
    [SPECIES_EMPOLEON_MEGA_O] =
    {
        ...
        .abilities = { ABILITY_RUSTY_AURA, ABILITY_RUSTY_AURA, ABILITY_RUSTY_AURA, ABILITY_RUSTY_AURA, ABILITY_RUSTY_AURA, ABILITY_RUSTY_AURA },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_EMPOLEON_MEGA_D] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_FIELD),
        .abilities = { ABILITY_LIGHTNING_ROD, ABILITY_LIGHTNING_ROD, ABILITY_LIGHTNING_ROD, ABILITY_LIGHTNING_ROD, ABILITY_LIGHTNING_ROD, ABILITY_LIGHTNING_ROD },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Empoleon"),
        .cryId = CRY_EMPOLEON,
        .natDexNum = NATIONAL_DEX_EMPOLEON,
    ...
    [SPECIES_SLAKING_MEGA] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_COMATOSE, ABILITY_COMATOSE, ABILITY_COMATOSE, ABILITY_COMATOSE, ABILITY_COMATOSE, ABILITY_COMATOSE },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_ROSERADE_MEGA] =
    {
        ...
        [SPECIES_DIALGA_PRIMAL] =
        {
            ...
            .growthRate = GROWTH_SLOW,
            .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
            .abilities = { ABILITY_PRIMAL_ARMOR, ABILITY_PRIMAL_ARMOR, ABILITY_PRIMAL_ARMOR, ABILITY_PRIMAL_ARMOR, ABILITY_PRIMAL_ARMOR, ABILITY_PRIMAL_ARMOR },
            .bodyColor = BODY_COLOR_WHITE,
