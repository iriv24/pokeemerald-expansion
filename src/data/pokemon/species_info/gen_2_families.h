...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset, rzMode)   \
    ...
    [SPECIES_GIRAFARIG] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 40, SPECIES_FARIGIRAF}),
    },
    ...
    [SPECIES_DUNSPARCE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_MOVE_TWO_SEGMENT, MOVE_HYPER_DRILL, SPECIES_DUDUNSPARCE_TWO_SEGMENT},
                                {EVO_LEVEL, 28, SPECIES_DUDUNSPARCE_THREE_SEGMENT}),
    },
    ...
    [SPECIES_URSARING] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL_DAY, 61, SPECIES_URSALUNA},
                                {EVO_LEVEL_NIGHT, 61, SPECIES_URSALUNA_BLOODMOON}),
    },
