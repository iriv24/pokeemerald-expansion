...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    [SPECIES_NOCTOWL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = {ABILITY_TINTED_LENS,  ABILITY_TINTED_LENS,  ABILITY_INSOMNIA },
        .bodyColor = BODY_COLOR_BROWN,
...
#define TOGEPI_FAMILY_TYPE (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_NORMAL)
    ...
    [SPECIES_WOOPER_PALDEA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_FIELD),
        .abilities = {ABILITY_POISON_TOUCH,  ABILITY_UNAWARE, ABILITY_WATER_ABSORB },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Wooper"),
        .cryId = CRY_WOOPER,
        .natDexNum = NATIONAL_DEX_WOOPER,
    ...
    [SPECIES_MURKROW] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = {ABILITY_PRANKSTER, ABILITY_PRANKSTER, ABILITY_SUPER_LUCK },
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset, rzMode)   \
    ...
    [SPECIES_PINECO] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_METAL_COAT, SPECIES_FORRETRESS}),
    },
    ...
    [SPECIES_QWILFISH] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
        .abilities = { ABILITY_INTIMIDATE,  ABILITY_INTIMIDATE, ABILITY_TOXIC_DEBRIS },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_QWILFISH_HISUI] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
        .abilities = { ABILITY_INTIMIDATE,  ABILITY_INTIMIDATE, ABILITY_POISON_TOUCH },
        .bodyColor = BODY_COLOR_BLACK,
        .speciesName = _("Qwilfish"),
        .cryId = CRY_QWILFISH,
        .natDexNum = NATIONAL_DEX_QWILFISH,
    ...
    [SPECIES_WEAVILE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = {ABILITY_PRESSURE,  ABILITY_INFILTRATOR, ABILITY_FRISK },
        .bodyColor = BODY_COLOR_BLACK,
    ...
    [SPECIES_SNEASEL_HISUI] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = {ABILITY_INNER_FOCUS,  ABILITY_POISON_TOUCH,  ABILITY_POISON_TOUCH },
        .bodyColor = BODY_COLOR_GRAY,
        .noFlip = TRUE,
        .speciesName = _("Sneasel"),
        .cryId = CRY_SNEASEL,
    ...
    [SPECIES_REMORAID] =
    {
        ...
        .abilities = {ABILITY_SKILL_LINK, ABILITY_HUSTLE, ABILITY_SNIPER },
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_OCTILLERY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_WATER_2),
        .abilities = { ABILITY_SKILL_LINK, ABILITY_MEGA_LAUNCHER, ABILITY_SNIPER },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_PHANPY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = {ABILITY_PICKUP,  ABILITY_BATTLE_ARMOR,  ABILITY_SAND_VEIL },
        .bodyColor = BODY_COLOR_BLUE,
