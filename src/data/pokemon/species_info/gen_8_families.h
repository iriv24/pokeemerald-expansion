...
const struct SpeciesInfo gSpeciesInfoGen8[] =
{
    ...
    [SPECIES_HYDRAPPLE] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS, EGG_GROUP_DRAGON),
        .abilities = {  ABILITY_STICKY_HOLD,  ABILITY_NONE,  ABILITY_REGENERATOR },
        .bodyColor = BODY_COLOR_GREEN,
...
#define ALCREMIE_REGULAR_SPECIES_INFO(sweet, cream, color, rzMode)                                      \
    ...
    [SPECIES_DRACOZOLT] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = {  ABILITY_SAND_RUSH,  ABILITY_SAND_RUSH,  ABILITY_VOLT_ABSORB },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_ZARUDE] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = {  ABILITY_DEFIANT,  ABILITY_NONE,  ABILITY_LEAF_GUARD },
        .bodyColor = BODY_COLOR_GREEN,
