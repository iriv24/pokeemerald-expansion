...
const struct SpeciesInfo gSpeciesInfoGen8[] =
{
    ...
    [SPECIES_DIPPLIN] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_STICKY_HOLD, ABILITY_GLUTTONY, ABILITY_NONE, ABILITY_STICKY_HOLD, ABILITY_GLUTTONY, ABILITY_NONE},
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_HYDRAPPLE] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS, EGG_GROUP_DRAGON),
        .abilities = { ABILITY_STICKY_HOLD, ABILITY_REGENERATOR, ABILITY_NONE, ABILITY_STICKY_HOLD, ABILITY_REGENERATOR, ABILITY_NONE},
        .bodyColor = BODY_COLOR_GREEN,
