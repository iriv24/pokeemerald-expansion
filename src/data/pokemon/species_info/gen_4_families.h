...
const struct SpeciesInfo gSpeciesInfoGen4[] =
{
    ...
    [SPECIES_TURTWIG] =
    {
        ...
        .abilities = { ABILITY_SHELL_ARMOR,  ABILITY_NONE,  ABILITY_SELF_SUFFICIENT},
...
#define MOTHIM_SPECIES_INFO(rzMode)                                         \
    ...
    [SPECIES_LUMINEON] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_2),
        .abilities = { ABILITY_DAZZLING,  ABILITY_NONE,  ABILITY_WATER_ABSORB},
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_SNOVER] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_GRASS),
        .abilities = { ABILITY_SOUNDPROOF,  ABILITY_ICE_BODY,  ABILITY_SNOW_WARNING},
        .bodyColor = BODY_COLOR_WHITE,
    ...
    [SPECIES_REGIGIGAS] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_COMATOSE,  ABILITY_NONE,  ABILITY_SLOW_START},
        .bodyColor = BODY_COLOR_WHITE,
