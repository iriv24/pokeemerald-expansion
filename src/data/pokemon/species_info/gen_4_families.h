...
const struct SpeciesInfo gSpeciesInfoGen4[] =
{
    ...
    [SPECIES_PIPLUP] =
    {
        ...
        .abilities = { ABILITY_TORRENT,  ABILITY_COMPETITIVE,  ABILITY_NONE},
    ...
    [SPECIES_STARLY] =
    {
        ...
        .abilities = { ABILITY_FRISK,  ABILITY_RECKLESS,  ABILITY_NONE},
        .bodyColor = BODY_COLOR_BROWN,
...
#define MOTHIM_SPECIES_INFO(rzMode)                                         \
    ...
    [SPECIES_PURUGLY] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_THICK_FAT,  ABILITY_DEFIANT,  ABILITY_OWN_TEMPO},
        .bodyColor = BODY_COLOR_GRAY,
