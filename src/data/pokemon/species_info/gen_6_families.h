...
const struct SpeciesInfo gSpeciesInfoGen6[] =
{
    ...
    [SPECIES_CHESPIN] =
    {
        ...
        .abilities = {    ABILITY_BULLETPROOF,   ABILITY_IRON_BARBS,   ABILITY_NONE   },
    ...
    [SPECIES_CHESNAUGHT_MEGA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_STAMINA, ABILITY_NONE, ABILITY_BULLETPROOF },
        .bodyColor = BODY_COLOR_GREEN,
        .speciesName = _("Chesnaught"),
        .cryId = CRY_CHESNAUGHT,
        .natDexNum = NATIONAL_DEX_CHESNAUGHT,
    ...
    [SPECIES_FLETCHLING] =
    {
        ...
        .abilities = {    ABILITY_FRISK,   ABILITY_GALE_WINGS,   ABILITY_NONE   },
        .bodyColor = BODY_COLOR_RED,
...
#define FURFROU_MISC_INFO(_form, _noFlip, frontWidth, frontYOffset, backWidth, backYOffset, _iconIdx)   \
    ...
    [SPECIES_GOOMY] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 34, SPECIES_SLIGGOO},
    ...
    [SPECIES_PUMPKABOO_AVERAGE] =
    {
        ...
        .abilities = {    ABILITY_FLARE_BOOST,   ABILITY_FLARE_BOOST,   ABILITY_FRISK   },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_NOIBAT] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
    #endif
        .abilities = {    ABILITY_TELEPATHY,   ABILITY_INFILTRATOR,   ABILITY_FRISK   },
        .bodyColor = BODY_COLOR_PURPLE,
