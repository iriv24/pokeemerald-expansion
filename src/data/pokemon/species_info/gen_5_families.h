...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    [SPECIES_MUNNA] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SYNCHRONIZE, ABILITY_NONE, ABILITY_TELEPATHY, ABILITY_SYNCHRONIZE, ABILITY_NONE, ABILITY_TELEPATHY },
    ...
    [SPECIES_MUSHARNA] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_SYNCHRONIZE, ABILITY_NONE, ABILITY_UNAWARE, ABILITY_SYNCHRONIZE, ABILITY_NONE, ABILITY_UNAWARE },
        .bodyColor = BODY_COLOR_PINK,
