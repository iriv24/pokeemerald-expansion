...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    [SPECIES_BLITZLE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_LIGHTNING_ROD,  ABILITY_FLARE_BOOST,  ABILITY_SAP_SIPPER},
    ...
    [SPECIES_MARACTUS] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_GRASS),
        .abilities = { ABILITY_GRASSY_SURGE,  ABILITY_CHLOROPHYLL,  ABILITY_WATER_ABSORB},
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_DUCKLETT] =
    {
        ...
        .abilities = { ABILITY_HYDRATION,  ABILITY_NONE,  ABILITY_FRISK},
        .bodyColor = BODY_COLOR_BLUE,
