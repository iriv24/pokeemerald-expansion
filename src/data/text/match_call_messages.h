...
const u8 gText_MatchCallPkmnBreeder_Ezekiel_Strategy[] = _("Full-on attack!");
const u8 gText_MatchCallPkmnBreeder_Ezekiel_Pokemon[] = _("Anything. I'll raise it.");
const u8 gText_MatchCallPkmnBreeder_Ezekiel_Intro1[] = _("I give them {POKEBLOCK}S for");
const u8 gText_MatchCallPkmnBreeder_Ezekiel_Intro2[] = _("going after CONTEST titles.");
...
const u8 *const gMatchCallFlavorTexts[REMATCH_TABLE_ENTRIES][CHECK_PAGE_ENTRY_COUNT] =
{
    ...
    [REMATCH_EZEKIEL] = MCFLAVOR(PkmnBreeder_Ezekiel),
