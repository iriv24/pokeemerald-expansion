...
const u32 gItemIcon_InstantCandy[] = INCBIN_U32("graphics/items/icons/candy_jar.4bpp.lz");
const u32 gItemIconPalette_InstantCandy[] = INCBIN_U32("graphics/items/icon_palettes/candy_jar.gbapal.lz");
