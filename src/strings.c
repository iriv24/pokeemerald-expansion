...
const u8 gText_LeagueChamp[] = _("Pokémon Emerald Imperium v2.0:\nLeague Champion, congratulations!");
...
const u8 gText_MenuReturnItems[] = _("GetItems");
