...
const u8 gText_WelcomeToHOF[] = _("Pokémon Emerald Imperium v1.0.0\nWelcome to the Hall of Fame!");
...
const u8 gText_LeagueChamp[] = _("Pokémon Emerald Imperium v1.0.0:\nLeague Champion, congratulations!");
...
const u8 gText_InfiniteRepelOn[] = _("Enabled{PAUSE_UNTIL_PRESS}");
const u8 gText_InfiniteRepelOff[] = _("Disabled{PAUSE_UNTIL_PRESS}");
