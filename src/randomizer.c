...
const u16 gStarterAndGiftMonTable[MY_STARTER_AND_GIFT_MON_COUNT] =
{
    ...
    SPECIES_ANORITH,
    SPECIES_MELTAN,
    SPECIES_CELEBI, // TODO REMOVE FROM ROUTES
    SPECIES_DARKRAI, //36
    ...
    SPECIES_VICTINI, // TODO REMOVE FROM ROUTES
    SPECIES_HOOPA_CONFINED, // TODO REMOVE FROM ROUTES
    SPECIES_DITTO,
    SPECIES_GENESECT, // TODO REMOVE FROM ROUTES
    SPECIES_MELOETTA_ARIA // TODO REMOVE FROM ROUTES
};
