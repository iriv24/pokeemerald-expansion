...
#define OW_FLAG_POKE_RIDER          FLAG_RIVAL_110 // If this flag is set, the player will be able to use fly from the Pokenav Region Map section by pressing 'R' on a city/location they have been to.
