...
extern const u8 BattleScript_TrainerBallBlockLegendaryOrMythical[];
extern const u8 BattleScript_TrainerBallBlockParadoxOrUltraBeast[];
...
extern const u8 BattleScript_WistfulEchoActivates[];
