...
#define SHOULD_RUN_ROM_CHECK FALSE       //  Verify that the patching was successful
#define SHOULD_RUN_RAM_CHECK FALSE       //  Verify that no savestate has been carried over
